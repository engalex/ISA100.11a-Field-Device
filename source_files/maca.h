...
extern void RadioInit(uint32 u32ClockFreq, uint8 u8PN, uint32 u32LoopDiv);
extern void SetChannel(uint8 channel,  uint8 RFSynVCODivI, uint32 RFSynVCODivF);

void MACA_SetEngineeringMode(uint8 p_ucEngineeringMode, uint8 p_ucChannel, uint8 p_ucPower );

...
#define MAX_RX_APDU_SIZE                  90    //98 - 8(IPv6 TL header without Sec) ->based on SM configuration of the Max NSDU Size
#define ISA100_APDU_INDICATE_PARAM_LEN    20
#define API_MSG_CRC_SIZE                   2
#define MAX_API_BUFFER_SIZE  (sizeof(ApiMessageFrame) + ISA100_APDU_INDICATE_PARAM_LEN + MAX_RX_APDU_SIZE)
